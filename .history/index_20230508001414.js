...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals) {
    ...
    zooAnimals.forEach(animal => {
      ...
      const displayName = `name: ${animalName}, scientific: ${scientificName}`;
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const filteredArray = zooAnimals.filter(animal => animal.population < 5);
...
// ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️console.log(cuboid.volume()); // 100
